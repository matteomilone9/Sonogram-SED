...
fan_dataset = AudioDataset(
    audio_dir="audio_anomali/ventola_1s",
    supervised=False)
...
trainer_(model=ae_model, train_loader=ae_train_loader, val_loader=ae_val_loader,
         ...
         results_dir="V6_results_1s", csv_name="training_log_1s_V6_2.csv", model_name="best_model_1s_V6_2.pth")